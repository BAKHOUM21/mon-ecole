    ...
    <div class="container">
        <nav>
            ...
            <div id="mySidenav" class="sidenav">
                    ...
                    <ul>
                        <li><a href="src/acceuil.php">Acceuil</a></li>
                        <li><a href="src/niveau.php">Niveau</a></li>
        ...
        <div class="card bg-light mt-5 mb-5" style="width:100%;">
            <div class="card-body">
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                    ...
                    <div class="view">
                        <img class="d-block w-100" src="img/ecole1.jpg"
                ...
                <div class="carousel-item">
                    <div class="view">
                        <img class="d-block w-100" src="img/ecole6.jpg"
        ...
        <div class="parallax parallax1">
            ...
            <div class="row container d-flex" style="margin:auto">
                <div class="card col-3" style="margin-bottom:5%">
                  ...
                  <div class="card-body">
                    <form>
                          ...
                          <div class="form-outline mb-4">
                            ...
                            <label class="form-label" for="form7Example3">Nom de votre structure</label>
                          </div>
                          ...
                          <div class="btn btn-submit justify-content-center mb-2">
                            <input class="btn btn-primary me-2" type="submit" value="Envoyer" id="form7Example8" />
                          </div>
                        </form>
                      </div>
                    </div>
